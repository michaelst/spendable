...
import { CREATE_TRANSACTION, DELETE_TRANSACTION, GET_TRANSACTION, LIST_BUDGETS, LIST_BUDGET_ALLOCATION_TEMPLATES, UPDATE_TRANSACTION } from '../queries'
...
const TransactionForm = ({ id, show, setShow }: TransactionFormProps) => {
  return id ?
    ...
    : <CreateTranasctionForm show={show} setShow={setShow} />
}

const CreateTranasctionForm = ({ show, setShow }: TransactionFormProps) => {

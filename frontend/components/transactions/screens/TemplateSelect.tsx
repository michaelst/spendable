...
import { LIST_TEMPLATES } from 'components/settings/queries'
import { ListAllocationTemplates, ListAllocationTemplates_allocationTemplates } from 'components/settings/graphql/ListAllocationTemplates'

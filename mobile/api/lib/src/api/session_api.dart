...
class SessionApi {
  ...
  /// Attaches a second provider to the account making the request. Nothing about a person is stored that would let the app match them across providers, so this is the only way two sign-in methods reach one account - and it has to be done from inside it. 
  ///
  /// Parameters:
  ...
  Future<Response<Identity>> createIdentity({ 
    ...
    try {
      ...
      _bodyData = sessionRequest == null ? null : _serializers.serialize(sessionRequest, specifiedType: _type);
  ...
  /// Sign in
  /// Exchanges an ID token from a native sign-in for an API token.
  ///
  /// Parameters:
  /// * [sessionRequest] - Credentials
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Session>> createSession({ 
    SessionRequest? sessionRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Refused for the last one, which would leave an account nobody can get back into.
  ///
  /// Parameters:
  /// * [id] - 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  Future<Response<void>> deleteIdentity({ 
    ...
    final _path = r'/api/identities/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Sign out
  /// Revokes the token the request was made with.
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// The signed-in user
  /// Carries the sign-in methods on the account, so the client can offer to add one.
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
